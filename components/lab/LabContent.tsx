        ...
        >
          {onClose && (
            <button
              type="button"
              onClick={onClose}
              className="border-2 px-4 py-2.5 font-typewriter text-[20px] uppercase transition-opacity hover:opacity-75 shrink-0"
              style={{
          ...
          <div>
            <h1
              className="font-typewriter text-[28px] font-bold uppercase tracking-widest"
              style={{ color: "var(--noir-sepia)" }}
            >
              The Lab
            </h1>
            <p className="font-typewriter text-[16px]" style={{ color: "var(--noir-cream)", opacity: 0.6 }}>
