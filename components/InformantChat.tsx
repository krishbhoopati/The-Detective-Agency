    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed right-0 top-1/2 z-50 flex min-h-[128px] -translate-y-1/2 items-center justify-center border-2 px-2.5 font-typewriter text-[15px] font-bold uppercase tracking-widest [writing-mode:vertical-rl]"
          style={{
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="fixed right-0 top-1/2 z-50 flex h-[450px] w-[300px] max-w-[calc(100vw-20px)] -translate-y-1/2 flex-col border-2 shadow-2xl"
            style={{
              backgroundColor: "var(--noir-dark)",
              borderColor: "var(--noir-sepia)",
          ...
          >
            ...
            >
              <h2 className="font-typewriter text-[18px] font-bold uppercase">
                Informant
              </h2>
              <button
                type="button"
                onClick={closePanel}
                className="flex h-11 w-11 items-center justify-center border-2 text-[22px]"
                style={{
                  borderColor: "var(--noir-sepia)",
                  color: "var(--noir-sepia)",
                }}
                ...
                <div className="space-y-4">
                  {messages.map((message, index) => (
                    <div key={`${message.role}-${index}`}>
                      <p
                        className="mb-1 font-typewriter text-[15px] font-bold uppercase"
            ...
            >
              ...
              <div className="flex gap-2">
                <input
                  ...
                  disabled={isSending}
                  className="min-h-[44px] min-w-0 flex-1 border-2 px-3 text-[15px]"
                  style={{
                ...
                <button
                  ...
                  className="min-h-[44px] min-w-[56px] border-2 px-3 font-typewriter text-[15px] font-bold uppercase disabled:cursor-not-allowed disabled:opacity-50"
                  style={{
                    borderColor: "var(--noir-sepia)",
